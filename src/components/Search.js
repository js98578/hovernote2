...
const Search = props => {
  ...
  return (
    <div
      className={
        focused
          ? 'p-2 mx-4 group rounded-lg border-teal-500 cursor-text border flex bg-gray-100 group-hover:bg-gray-200'
          : 'p-2 mx-4 group rounded-lg border-teal-500 cursor-text border flex group-hover:bg-gray-200'
      }
      onClick={() => focusField()}
    >
      <input
